...
### ✅ Current Status
This project is working and ready for demo usage.
...
The chart below is generated by running `make viz` (or `make full-run`):

![IndexForge performance chart](assets/index_performance.png)
